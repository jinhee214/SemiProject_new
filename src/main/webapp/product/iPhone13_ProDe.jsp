	...
	for(ProductDto dto:list)
		...
		<tr align="center">
			...
			<form action="product/addProAction.jsp" method="post">
				...
				<tr>
						<th width="100" height="100" colspan="2" style="font-size: 25pt;">iPhone 13 Pro</th>
					</tr>
					
					<tr>
					<th width="100" colspan="2" style="font-size: 1.3em;">￦1,350,000</th>
					</tr>
		...
		<tr>
			<td align="center" colspan="2" height="100">
				...
				<input type="hidden" value="1350000" name="price">
