	...
	for(ProductDto dto:list)
		...
		<tr align="center">
			...
			<form action="product/addProAction.jsp" method="post">
				...
				<tr>
						<th width="100" height="100" colspan="2" style="font-size: 25pt;">AirPods 2</th>
					</tr>
					
					<tr>
					<th width="100" colspan="2" style="font-size: 1.3em;">￦179,000</th>
					</tr>
