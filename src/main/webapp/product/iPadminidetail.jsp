...
<body>
<img alt="" src="AppleProduct_img/iPad_miniDe.PNG" class="mainimg">

<button class="glyphicon glyphicon-chevron-left btn btn-secondary btn-lg"
onclick="location.href='index.jsp?main=product/iPadlist.jsp'" style="margin-top: 700px;">뒤로가기</button>
